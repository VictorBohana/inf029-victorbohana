...
void validarNascimento(char* nascimento){
    for(int i = 0; i < 11; i++)
    {
        if(nascimento[i] != '0' && nascimento[i] != '1' && nascimento[i] != '2' && nascimento[i] != '3' 
            ...
            && nascimento[i] != '8' && nascimento[i] != '9' && nascimento[i] != '/' && nascimento[i] != '\0')
        {
    ...
    if(nascimento[3] != '0' && nascimento[3] != '1')
    {
        printf("Mes de nascimento invalido.\n");
        exit(0);
    }
    if(nascimento[3] == '1'){
        if(nascimento[4] != '0' && nascimento[3] != '1' && nascimento[3] != '2')
        {
            printf("Mes de nascimento invalido.\n");
            exit(0);
        }
    ...
    if(nascimento[2] != '/' && nascimento[5] != '/'){
        printf("Formatacao da data incorreta.\n");
        exit(0);
    }
}
